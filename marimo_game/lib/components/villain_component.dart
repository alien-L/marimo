...
class VillainController extends Component
  ...
  Future<void> onNewState(int state) async {
    ...
    final villainComponent = VillainComponent(
  ...
  //  game.villainComponent.removeFromParent();
    ...
    parent?.add(gameRef.marimoComponent = MarimoComponent(
    ...
    await GameAlert().showMyDialog(
        text: "꺅!!!빌런이 나타났어요!!!!!",
        assetsName:
            "assets/images/${villainComponent.getVillainInfoMap()["name"]}.png",
        dialogNumber: "02");
  }
}
...
class VillainComponent extends SpriteComponent
  ...
  void onTapUp(TapUpEvent event) {
    GameAlert().showMyDialog(
        text: getVillainInfoMap()["message"],
        assetsName: "assets/images/${getVillainInfoMap()["name"]}.png",
        dialogNumber: "02");
  }
